...
export const projects: Project[] = [
  ...
  },
  {
    ...
    captures: [
      ...
      {
        src: '/screenshots/jcc-foot-preview06.PNG',
        alt: 'Ouverture de pack mobile JCC Football',
        width: 1170,
        height: 2532,
      },
      {
        src: '/screenshots/jcc-foot-preview07.PNG',
  ...
  },
  {
    ...
    title: 'Website KOP',
    tagline:
      'Site internet de lâ€™application King Of Paddock. Travail sur le referencement SEO et une page news dâ€™informations F1.',
    shortDescription: '',
    ...
    category: 'product',
    skills: [
      'Structure de site produit',
      'Contenus orientes SEO',
    ...
    githubUrl: '',
    links: [
      { label: 'kingofpaddock.com', url: 'https://kingofpaddock.com', icon: 'link' },
    ],
    need: {
      body: [
        'Le site King Of Paddock sert a donner une presence publique plus claire au produit et a travailler son acquisition.',
        'Lâ€™objectif est de sortir du simple produit applicatif pour construire un support de visibilite : pages publiques, contenu F1, referencement et lecture des performances.',
      ],
    },
    build: {
      body: [
        'Jâ€™ai travaille la structure du site, les contenus orientes SEO, lâ€™integration de pages news et les premieres logiques de suivi via analytics et workflows.',
      ],
      features: [
        {
          title: 'Site vitrine produit',
          description: 'Pages publiques pour presenter lâ€™application King Of Paddock.',
        },
        {
          title: 'SEO',
          description: 'Structure de contenu pour capter des recherches autour de la F1 et du fantasy.',
        },
        {
          title: 'Page news',
          description: 'Support editorial pour publier des informations F1.',
        },
        {
          title: 'Analytics',
          description: 'Suivi des performances et des comportements via Google Analytics.',
        },
      ],
    },
    captures: [
      {
        src: '/screenshots/king-of-paddock-site-card.webp',
        alt: 'Apercu du site King Of Paddock',
        full: true,
      },
    ],
    now: {
      body: [
        'Le site peut continuer a evoluer autour du contenu F1, de la clarte des pages produit et de lâ€™analyse des canaux qui amenent les bons visiteurs.',
      ],
    },
    cta: {
